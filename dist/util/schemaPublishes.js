...
const generateSchemaPublishesReport = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield client.BVR_CLI_SchemaPublishes({
        accountId,
        from: (0, timestamps_1.offsetToTimestamp)(from),
        resolution: sdk_1.Resolution.R1D,
    });
    const records = (_b = (_a = res.organization) === null || _a === void 0 ? void 0 : _a.registryStatsWindow) === null || _b === void 0 ? void 0 : _b.schemaPublishStats.map(stat => ({
