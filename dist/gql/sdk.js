...
exports.Bvr_Cli_ValidateTokenDocument = (0, graphql_tag_1.default) `
  ...
  me {
    ...
    `;
exports.Bvr_Cli_ValidateAccountIdDocument = (0, graphql_tag_1.default) `
  ...
  account(id: $accountId) {
    ...
    `;
exports.Bvr_Cli_ClientUsageDocument = (0, graphql_tag_1.default) `
  ...
  account(id: $accountId) {
    ...
    `;
exports.Bvr_Cli_FieldChangeSummaryDocument = (0, graphql_tag_1.default) `
  ...
  account(id: $accountId) {
    ...
    `;
exports.Bvr_Cli_FieldRecordsDocument = (0, graphql_tag_1.default) `
  ...
  account(id: $accountId) {
    ...
    `;
exports.Bvr_Cli_FieldUsageDocument = (0, graphql_tag_1.default) `
...
exports.Bvr_Cli_OperationCountsDocument = (0, graphql_tag_1.default) `
  ...
  organization(id: $accountId) {
    ...
    `;
exports.Bvr_Cli_SchemaChecksDocument = (0, graphql_tag_1.default) `
  ...
  organization(id: $accountId) {
    ...
    `;
exports.Bvr_Cli_SchemaPublishesDocument = (0, graphql_tag_1.default) `
...
function getSdk(client, withWrapper = defaultWrapper) {
    return {
        BVR_CLI_ValidateToken(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.Bvr_Cli_ValidateTokenDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'BVR_CLI_ValidateToken', 'query', variables);
        },
        BVR_CLI_ValidateAccountId(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.Bvr_Cli_ValidateAccountIdDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'BVR_CLI_ValidateAccountId', 'query', variables);
        },
        BVR_CLI_ClientUsage(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.Bvr_Cli_ClientUsageDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'BVR_CLI_ClientUsage', 'query', variables);
        },
        BVR_CLI_FieldChangeSummary(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.Bvr_Cli_FieldChangeSummaryDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'BVR_CLI_FieldChangeSummary', 'query', variables);
        },
        BVR_CLI_FieldRecords(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.Bvr_Cli_FieldRecordsDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'BVR_CLI_FieldRecords', 'query', variables);
        },
        ...
        BVR_CLI_SchemaChecks(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.Bvr_Cli_SchemaChecksDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'BVR_CLI_SchemaChecks', 'query', variables);
        },
